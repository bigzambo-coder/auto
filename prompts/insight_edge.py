...
- 인사이트 엣지 SEO 최적 텍스트: 순수 텍스트 기준 5000~7000자 목표
- 각 <h2> 섹션: 최소 500자 이상의 텍스트 (이미지 제외)
...
- [본문]:
  * [텍스트 분량] 순수 텍스트 5000~7000자 목표 (이미지 <div> 태그는 0자로 계산, 이미지 장수와 완전히 무관)
  ...
  * <h2> 소제목 4~6개로 구조화, 각 섹션 500자 이상 풍부한 텍스트 → 이미지 삽입 후에도 텍스트는 계속 이어짐
